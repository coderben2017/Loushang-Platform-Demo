...
var parameterFromRoot="${l:getRootPreference('skinType')}";
// 定义表格对象
var grid;
// 表格数据
var data = [];
	   ...
	   <div class="row">
		<form class="form-inline" onsubmit="return false;">										
			<div class="input-group">
		        <input class="form-control ue-form" type="text" id="productName" placeholder="<spring:message code="product.Name" text="商品名称"/>"/>
		        <div class="input-group-addon ue-form-btn" id="query">
		        	<span class="fa fa-search"></span>
		        </div>
	        </div>
		    <a class="btn ue-btn dbtn" id="moresearch"><spring:message code="user.searchmore" text="更多搜索"/><i class="fa fa-angle-down"></i></a>
		    <div class="btn-group pull-right">
				<button id="add" type="button"
					class="btn ue-btn">
					<span class="fa fa-plus"></span><spring:message code="product.Add" text="增加"/> 
				</button>
				<button id="del" type="button"
					class="btn ue-btn">
					<span class="fa fa-minus"></span><spring:message code="product.Del" text="删除"/>
				</button>
				<button id="save" type="button"
					class="btn ue-btn">
					<span class="fa fa-save"></span><spring:message code="product.Save" text="保存"/> 
				</button>
			</div>
		</form>
	</div>
		<table id="productList">
			<thead>
				<tr>
					...
					<th width="20%" data-field="productCode" data-editor="text"><spring:message code="product.Number" text="商品编号"/></th>
					<th width="25%" data-field="productName" data-sortable="true" data-editor="text"><spring:message code="product.Name" text="商品名称"/></th>
					<th width="15%" data-field="productType" data-editor="select" data-source="getTypeSelectVal" data-render="renderstatus"><spring:message code="product.Category" text="商品类别"/></th>
                    <th width="15%" data-field="productNum" data-editor="text" data-validator="isNumber"><spring:message code="product.Quantity" text="商品数量"/></th>	
                    <th width="20%" data-field="productDate" data-editor="date"><spring:message code="product.ProductionDate" text="生产日期"/></th>
                </tr>
			</thead>
		</table>
	</div>
